        ...
        <div className="bg-[#FAF9F6] p-10 rounded-[2.5rem] shadow-2xl border-b-8 border-[#D4AF37]/30">
          <div className="flex flex-col items-center mb-10">
            ...
            <h2 className="text-2xl font-black tracking-tighter text-center uppercase" style={{ color: MAROON }}>
               <span className="text-gray-400 font-serif italic font-medium lowercase">admin</span>
            </h2>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-4 border border-gray-100 rounded-2xl outline-none focus:ring-1 focus:ring-[#4A0404] bg-gray-50 transition-all text-sm font-bold text-[#2B2B2B]" 
            ...
            <button 
              disabled={loading}
              className="w-full text-white py-4 rounded-2xl font-black uppercase tracking-[0.2em] text-sm hover:brightness-110 transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2 mt-4"
